# Generated by Django 2.2.20 on 2021-07-09 13:25
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddConstraint(
            model_name='access',
            constraint=models.CheckConstraint(check=models.Q(models.Q(('user__isnull', False), ('contact__isnull', True)), models.Q(('user__isnull', True), ('contact__isnull', False)), _connector='OR'), name='user_or_contact_only'),
        ),
    ]
