...
class SelectProjectForm(forms.Form):
    ...
    project = forms.ModelChoiceField(queryset=Project.objects.all(), help_text='Select the project.')
...
class SelectDatasetForm(forms.Form):
    ...
    is_owned = forms.BooleanField(label='Dataset is owned', required=False,
