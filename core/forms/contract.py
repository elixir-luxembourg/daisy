...
class PartnerRoleForm(ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields['partner'].widget = SelectWithModal(url_name='partner_add', entity_name='partner',
                                                        choices=self.fields['partner'].widget.choices, )
        self.fields['contacts'].widget = SelectWithModal(url_name='contact_add', entity_name='contact',
