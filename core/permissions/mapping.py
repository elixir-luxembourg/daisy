...
PERMISSION_MAPPING = {
    "Contract": [
        ...
        (f'{Permissions.ADMIN.value}_contract', 'Can edit permissions on Contract instances'),
    ],
    "Dataset": [
        (f'{Permissions.PROTECTED.value}_dataset', 'Can edit PROTECTED elements of Dataset instances'),
        (f'{Permissions.ADMIN.value}_dataset', 'Can edit permissions on Dataset instances'),
    ],
    "Project": [
        (f'{Permissions.PROTECTED.value}_project', 'Can edit PROTECTED elements of Project instances'),
        (f'{Permissions.ADMIN.value}_project', 'Can edit permissions on Dataset instances'),
    ],
}
