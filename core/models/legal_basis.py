...
class LegalBasis(CoreModel):
    ...
    dataset = models.ForeignKey(
        "core.Dataset", related_name="legal_basis_definitions", on_delete=models.CASCADE
    )
    ...
    legal_basis_types = models.ManyToManyField(
        "core.LegalBasisType",
        blank=False,
    ...
    personal_data_types = models.ManyToManyField(
        "core.PersonalDataType",
        blank=True,
        related_name="legal_basis_definitions",
    ...
    def __str__(self):
        legal_basis_types = ",".join(
            str(lbt.code) for lbt in self.legal_basis_types.all()
        )
