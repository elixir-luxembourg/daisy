...
from web.views.contracts import (
    ContractCreateView,
    ContractEditView,
    ContractDelete,
    ContractDetailView,
...
from web.views.datasets import (
    DatasetCreateView,
    DatasetDetailView,
    DatasetEditView,
    DatasetDelete,
...
from web.views.projects import (
    ProjectCreateView,
    ProjectEditView,
    ProjectDetailView,
    ProjectDelete,
...
web_urls = [
    ...
    path(
        "partner_role/<int:pk>/edit",
        contracts.PartnerRoleEditView.as_view(),
        name="edit_partner_role",
    ),
    path(
        "partner_role/<int:pk>/delete",
        contracts.partner_role_delete,
        name="delete_partner_role",
    ),
    # Data declaration
    path(
        "dataset/<int:pk>/add-data-declaration",
        data_declarations.data_declarations_add,
        name="data_declarations_add",
    ),
    path(
        "data_declaration/<int:pk>/",
        DatadeclarationDetailView.as_view(),
        name="data_declaration",
    ),
    path(
        "data_declaration/<int:pk>/duplicate",
        data_declarations.data_declarations_duplicate,
        name="data_declarations_duplicate",
    ),
    path(
        "data_declaration/<int:pk>/delete",
        data_declarations.data_declarations_delete,
        name="data_declarations_delete",
    ),
    path(
        "data_declaration/<int:pk>/edit",
        DatadeclarationEditView.as_view(),
        name="data_declaration_edit",
    ),
    path(
        "data-declaration-sub-form",
        data_declarations.data_declarations_add_sub_form,
        name="data_declarations_add_sub_form",
    ),
    path(
        "data-declarations-get-contracts",
        data_declarations.data_declarations_get_contracts,
        name="data_declarations_get_contracts",
    ),
    # TODO: merge the two search views into one
    path(
        "data-declarations-autocomplete",
        data_declarations.data_declarations_autocomplete,
        name="data_declarations_autocomplete",
    ),
    path(
        "data-dec-paginated-search",
    ...
    path(
        "dataset/<int:dataset_pk>/storagelocation/add/",
        storage_locations.StorageLocationCreateView.as_view(),
        name="dataset_storagelocation_add",
    ),
    path(
        "dataset/<int:dataset_pk>/storagelocation/remove/<int:storagelocation_pk>/",
        storage_locations.remove_storagelocation,
        name="dataset_storagelocation_remove",
    ),
    path(
        "dataset/<int:dataset_pk>/storagelocation/<int:pk>/edit",
        storage_locations.StorageLocationEditView.as_view(),
        name="dataset_storagelocation_edit",
    ),
    # Dataset's Access (Internal access, as opposed to "Shares")
    path(
        "dataset/<int:dataset_pk>/access/add/",
        AccessCreateView.as_view(),
        name="dataset_access_add",
    ),
    path(
        "dataset/<int:dataset_pk>/access/remove/<int:access_pk>/",
        access.remove_access,
        name="dataset_access_remove",
    ),
    path(
        "dataset/<int:dataset_pk>/access/<int:pk>/edit",
        AccessEditView.as_view(),
        name="dataset_access_edit",
    ),
    # Dataset's LegalBasis
    path(
        "dataset/<int:dataset_pk>/legalbasis/add/",
        legalbasis.LegalBasisCreateView.as_view(),
        name="dataset_legalbasis_add",
    ),
    path(
        "dataset/<int:dataset_pk>/legalbasis/remove/<int:legalbasis_pk>/",
        legalbasis.remove_legalbasis,
        name="dataset_legalbasis_remove",
    ),
    path(
        "dataset/<int:dataset_pk>/legalbasis/<int:pk>/edit",
        legalbasis.LegalBasisEditView.as_view(),
        name="dataset_legalbasis_edit",
    ),
    # Dataset's Shares (External access, as opposed to "Access")
    path(
        "dataset/<int:dataset_pk>/share/add/",
        share.ShareCreateView.as_view(),
        name="dataset_share_add",
    ),
    path(
        "dataset/<int:dataset_pk>/share/remove/<int:share_pk>/",
        share.remove_share,
        name="dataset_share_remove",
    ),
    path(
        "dataset/<int:dataset_pk>/share/<int:pk>/edit",
        share.ShareEditView.as_view(),
        name="dataset_share_edit",
    ),
    # Dataset's Exposure methods
    path(
        "dataset/<int:dataset_pk>/exposure/add/",
        exposure.ExposureCreateView.as_view(),
    ...
    path(
        "dataset/<int:dataset_pk>/exposure/<int:pk>/edit",
    ...
    path(
        "definitions/cohorts/<int:pk>/delete",
        CohortDelete.as_view(),
        name="cohort_delete",
    ),
    path(
        "definitions/cohorts/<int:pk>/edit",
        CohortEditView.as_view(),
        name="cohort_edit",
    ),
    path("definitions/cohorts/<int:pk>/publish", publish_cohort, name="cohort_publish"),
    path(
        "definitions/cohorts/<int:pk>/unpublish",
        unpublish_cohort,
        name="cohort_unpublish",
    ),
    # Contacts
    path(
        "definitions/contacts/", contact_search_view, name="contacts"
    ),  # Formerly; ContactListView.as_view()
    path("definitions/contact/<int:pk>", ContactDetailView.as_view(), name="contact"),
    path(
        "definitions/contact/<int:pk>/edit",
        ContactEditView.as_view(),
        name="contact_edit",
    ),
    path("definitions/contacts/add/", ContactCreateView.as_view(), name="contact_add"),
    path(
        "definitions/contacts/<int:pk>/delete",
    ...
    path(
        "definitions/partners/<int:pk>/delete",
        PartnerDelete.as_view(),
        name="partner_delete",
    ),
    path(
        "definitions/partners/<int:pk>/edit",
        PartnerEditView.as_view(),
        name="partner_edit",
    ),
    path(
        "definitions/partners/<int:pk>/publish", publish_partner, name="partner_publish"
    ),
    path(
        "definitions/partners/<int:pk>/unpublish",
        unpublish_partner,
        name="partner_unpublish",
    ),
    # User Management
    path("definitions/users", UsersListView.as_view(), name="users"),
    path("definitions/users/add", UserCreateView.as_view(), name="users_add"),
    path(
        "definitions/users/change-password",
        change_password,
    ...
    # Documents
    path(
        "documents/<int:object_id>/<int:content_type>/add",
        documents.upload_document,
        name="document_add",
    ),
    path(
        "documents/<int:pk>/delete", documents.delete_document, name="document_delete"
    ),
    path(
    ...
    path(
        "permissions/project/<int:pk>/",
        permissions.index,
        {"selection": "project"},
        name="permission_project",
    ),
    path(
        "permissions/dataset/<int:pk>/",
        permissions.index,
        {"selection": "dataset"},
    ...
    path(
        "project/<int:pk>/add-contact",
        add_contact_to_project,
        name="add_contact_to_project",
    ),
    path(
        "project/<int:pk>/add-dataset",
        datasets.DatasetCreateView.as_view(),
        name="datasets_add_to_project",
    ),
    path(
        "project/<int:pk>/add-personnel",
        add_personnel_to_project,
        name="add_personnel_to_project",
    ),
    path(
        "project/<int:pk>/add-publication",
        add_publication_to_project,
        name="add_publication_to_project",
    ),
    path(
        "project/<int:pk>/del-contact/<int:contact_id>",
        remove_contact_from_project,
        name="remove_contact_from_project",
    ),
    path(
        "project/<int:pk>/del-personnel/<int:user_id>",
        remove_personnel_from_project,
        name="remove_personnel_from_project",
    ),
    path(
        "project/<int:pk>/del-publication/<int:publication_id>",
        remove_publication_from_project,
        name="remove_publication_from_project",
    ),
    path(
        "project/<int:pk>/pick-contact",
        pick_contact_for_project,
        name="pick_contact_for_project",
    ),
    path(
        "project/<int:pk>/pick-publication",
        pick_publication_for_project,
        name="pick_publication_for_project",
    ),
    # Project's contract
    path(
        "project/<int:pk>/contract/create",
        projects.project_contract_create,
        name="project_contract_create",
    ),
    path(
        "project/<int:pk>/contract/remove/<int:cid>",
        projects.project_contract_remove,
    ...
    path(
        "project/<int:pk>/dataset/create",
        projects.project_dataset_choose_type,
        name="project_dataset_choose_type",
    ),
    path(
    ...
    # Integrations
    path(
        "integrations/dsw/list-projects",
        dsw_list_projects,
        name="integrations_dsw_projects",
    ),
    # Activity log
