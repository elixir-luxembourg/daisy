    ...
    Plugin.prototype =
        {
            ...
            initHours: function () {
                ...
                for (var i = 0; i < 12; i++) {
                    ...
                    var fill = ((this.currentDate.format(hFormat) == i) ? "#00b09f" : 'transparent');
                ...
                if (!this.params.shortTime) {
                    for (var i = 0; i < 12; i++) {
                        ...
                        var fill = ((this.currentDate.format(hFormat) == (i + 12)) ? "#00b09f" : 'transparent');
            ...
            initMinutes: function () {
                ...
                for (var i = 0; i < 60; i++) {
                    ...
                    var color = ((this.currentDate.format("m") == i) ? "#00b09f" : 'transparent');
            ...
            _onSelectHour: function (e) {
                if (!$(e.target).hasClass('disabled')) {
                    ...
                    $(parent.find('#h-' + value)).attr('fill', '#00b09f');
            ...
            _onSelectMinute: function (e) {
                if (!$(e.target).hasClass('disabled')) {
                    ...
                    $(parent.find('#m-' + value)).attr('fill', '#00b09f');
