...
@permission_required_from_content_type(
    Permissions.PROTECTED, content_type_attr="content_type", object_id_attr="object_id"
)
@permission_required_from_content_type(
    Permissions.EDIT, content_type_attr="content_type", object_id_attr="object_id"
)
    ...
    if request.method == "POST":
        ...
        if not form.is_valid():
            ...
            return (
                ...
                else redirect(to=content_type_object.name, pk=object_id)
            )
    ...
    if request.method == "POST":
        ...
        if form.is_valid():
            ...
            return (
                ...
                if is_ajax_request(request)
                else redirect(to=document.content_type.name, pk=document.object_id)
            )
    else:
