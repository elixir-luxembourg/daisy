...
from test.factories import DatasetFactory, ProjectFactory, UserFactory, VIPGroup, DataStewardGroup, LegalGroup, AuditorGroup
...
@pytest.mark.parametrize('factory, url_name', [
    (DatasetFactory, 'permission_dataset'),
    (ProjectFactory, 'permission_project')
])
